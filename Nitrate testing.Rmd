...
```{r}
nitrate <- as.data.frame(read_csv("nitrate100000.csv")) #Load the .csv-file as a dataframe and save it as "cities".

nitrateagg <- as.data.frame(read_csv("nitrate100000agg.csv")) #Load the .csv-file as a dataframe and save it as "cities".
...
```{r}
marker <- st_read("Markblok.shp") %>% na.omit() #loading raster containing burial mounds. 
